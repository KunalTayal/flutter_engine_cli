...
This document provides practical examples of how to use the flutter_scaffold CLI tool.
...
flutter_scaffold add --name cart --state riverpod --with-g-routes
flutter_scaffold add --name profile
```
...
After running `flutter_scaffold init`, you can add additional dependencies:
...
After using flutter_scaffold, your project is ready for:
