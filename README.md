...
flutter_scaffold add --name user_profile --state riverpod --with-g-routes
flutter_scaffold add --name product_catalog --state bloc --with-g-routes
flutter_scaffold add --name settings
```
...
flutter_scaffold add --name user_profile

# Feature with Riverpod state management
flutter_scaffold add --name product_catalog --state riverpod

# Feature with BLoC state management and routing
flutter_scaffold add --name checkout --state bloc --with-g-routes
...
### Feature Development
1. **One feature per command**: Use `flutter_scaffold add` for each feature
