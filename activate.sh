...
# This script helps you activate the flutter_scaffold CLI tool globally
...
if [ ! -f "$SCRIPT_DIR/pubspec.yaml" ]; then
    ...
    echo "Please run this script from the flutter_scaffold project root"
    exit 1
fi
...
echo "🔧 Activating flutter_scaffold globally..."
dart pub global activate --source path .

if [ $? -ne 0 ]; then
    echo "❌ Error: Failed to activate flutter_scaffold"
    exit 1
fi
...
echo "  flutter_scaffold init    - Initialize a new Flutter project with Clean Architecture"
echo "  flutter_scaffold add     - Add a new feature to your project"
echo ""
echo "For more information, see the README.md file or run:"
echo "  flutter_scaffold --help"
echo ""
echo "Happy coding! 🚀"
